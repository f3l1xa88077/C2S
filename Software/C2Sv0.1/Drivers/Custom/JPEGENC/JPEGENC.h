...
#ifndef __JPEGENC__
#define __JPEGENC__
// USE_HAL_DRIVER added for the STM32Cube (bare-metal) build: STM32 projects always
// define it, and it selects the standard-C shims below instead of <Arduino.h>.
#if defined( MICROPY_PY_SENSOR ) || defined( __MACH__ ) || defined( __LINUX__ ) || defined( __MCUXPRESSO ) || defined( ESP_PLATFORM ) || defined( USE_HAL_DRIVER )
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
#include <stdio.h>
