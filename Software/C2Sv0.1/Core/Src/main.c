...
// Current Sense Amplifier (CSA) Variables
CSA_HandleTypeDef csa;
uint32_t prevTime = 0;
float powerSum = 0;
float powerAvg = 0;
float currentSum = 0;
...
//	  AR_Init_ImageSensor(&hi2c1);
  	  ...
  	  // Test microSD writing
//	  HAL_Delay(2000);
//	  Test_Image_Stream();

	  // Current Sense Amplifier
	  CSA_Init(&csa, SHUNT_RESISTANCE, 3.3f, 5.0f, 50);
	  ...
	  // OCTOSPI
//	  QSPI_Init_DataBlock(&DataChunk, sizeof(tx_str), tx_str, rx_str);
//	  QSPI_Write_Data(&QSPI_Memory, &DataChunk);
//	  QSPI_Read_Data(&QSPI_Memory, &DataChunk);
//	  QSPI_Erase_Data(&QSPI_Memory, &DataChunk);
  ...
  {
	  // Update LEDs
	  LED_SyncEncoder(ENCODER_VAL);

	  // Update and get CSA voltage
	  CSA_Update(&csa, &hadc1);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(PWR_ACTION_GPIO_Port, PWR_ACTION_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, SENSOR_LED_2_Pin|SENSOR_LED_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MCU_LED_1_Pin|MCU_LED_2_Pin|TRIGGER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, READ_LED_1_Pin|READ_LED_2_Pin|WRITE_LED_1_Pin|WRITE_LED_2_Pin
                          |DEBUG_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, PIN81_Pin|PIN84_Pin|PIN85_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PIN97_GPIO_Port, PIN97_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(STANDBY_GPIO_Port, STANDBY_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RESETBAR_GPIO_Port, RESETBAR_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : SCROLL_A_Pin */
  GPIO_InitStruct.Pin = SCROLL_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SCROLL_A_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SCROLL_B_Pin */
  GPIO_InitStruct.Pin = SCROLL_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SCROLL_B_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PWR_ACTION_Pin */
  GPIO_InitStruct.Pin = PWR_ACTION_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PWR_ACTION_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : SENSOR_LED_2_Pin SENSOR_LED_1_Pin */
  GPIO_InitStruct.Pin = SENSOR_LED_2_Pin|SENSOR_LED_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : MCU_LED_1_Pin MCU_LED_2_Pin TRIGGER_Pin */
  GPIO_InitStruct.Pin = MCU_LED_1_Pin|MCU_LED_2_Pin|TRIGGER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : READ_LED_1_Pin READ_LED_2_Pin WRITE_LED_1_Pin WRITE_LED_2_Pin
                           DEBUG_LED_Pin */
  GPIO_InitStruct.Pin = READ_LED_1_Pin|READ_LED_2_Pin|WRITE_LED_1_Pin|WRITE_LED_2_Pin
                          |DEBUG_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PIN81_Pin PIN84_Pin PIN85_Pin */
  GPIO_InitStruct.Pin = PIN81_Pin|PIN84_Pin|PIN85_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);

  /*Configure GPIO pin : PIN97_Pin */
  GPIO_InitStruct.Pin = PIN97_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PIN97_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : RESETBAR_Pin */
  GPIO_InitStruct.Pin = RESETBAR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(RESETBAR_GPIO_Port, &GPIO_InitStruct);
