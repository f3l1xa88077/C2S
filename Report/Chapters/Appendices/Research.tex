...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 1/Thick_Lens_Diagram.svg.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 1/distortion-2.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/spherical-abberation.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/astigmatism.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/curvature.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/chromatic.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/achromat.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/apochromat.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/IR-cut.jpg}
    \caption{Comparison of images with and without IR-cut filter.}
    \label{fig:IR-cut}
\end{indentedfigure}
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/IR-cut-diagram.jpg}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/IR-day-night.jpg}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 1/bayer-pattern.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 2/photodiode.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/full-well.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/pixel-diagram.png}
...
The formula for calculating the signal-to-noise ratio in dB is: $\texttt{SNR} = 20* \log (\texttt{signal}/\texttt{noise})$.
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/snr.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/ccd-schematic.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/cmos-schematic.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/Comparison_backside_illumination.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/photodiode-chain.jpg}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/sony-imx.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/sony-imx-wire.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/2-wire-protocol.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/gain-table.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/readout-pos.png}
    \caption{Readout Position.}
\end{indentedfigure}
Readout direction can be set by the registers:
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/readout-table.png}
    \caption{Image Orientation Register.}
\end{indentedfigure}
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/vh-mirror.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/temp-register.png}
    \caption{Temperature setting registers.}
\end{indentedfigure}
The following table shows the relationship between temperature and stored value:
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 2/temp-table.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.35\linewidth]{Images/Appendices/Research/Week 3/gamma-ex.jpg}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.4\linewidth]{Images/Appendices/Research/Week 3/kernel.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.4\linewidth]{Images/Appendices/Research/Week 3/average-kernel.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/Appendices/Research/Week 3/average-ex.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.7\linewidth]{Images/Appendices/Research/Week 3/gauss-kernel.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.7\linewidth]{Images/Appendices/Research/Week 3/mediabn-kernel.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.6\linewidth]{Images/Appendices/Research/Week 3/weiner-ex.png}
...
\begin{indentedfigure}
    \centering
    \includegraphics[width=0.7\linewidth]{Images/Appendices/Research/Week 3/bitdepth.png}
...
\begin{verbatim}
gst-launch-1.0 -v v4l2src device=/dev/video0 num-buffers=1 ! "video/x-bayer, format=rggb,
width=3280, height=2464" ! filesink location=test_3280x2464.bayer

./bayer2rgb --input=test_3280x2464.bayer --output=data.tiff --width=3296 --height=2464
--bpp=16 --first=RGGB --method=BILINEAR --tiff |
\end{verbatim}
