...
\paragraph{Remark}
The filters used to identify potential MCUs did not search for the JPEG codec which is why the compression was implemented via software.
Future versions of the project should use an alternative chip if JPEG compression is used.