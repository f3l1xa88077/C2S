...
\subsection{Systems Planning}\label{sec:v1-planning}
    ...
    \subsubsection{Trade Study}\label{sec:v1-trade}
...
% Testing
% -----------------------
\subsection{Testing}\label{sec:v1-testing}

Basic testing was performed to characterise the board, as the compressions algorithms had not been developed at the time of testing.
...
% Conclusion
% -----------------------
\subsection{Conclusion}\label{sec:v1-conclusion}
